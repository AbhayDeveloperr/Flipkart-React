            ...
            <div className="grid grid-cols-7 space-x-8">
                ...
                <div className="col-span-4">
                    ...
                    <div className="relative">
                        ...
                        }} type="search" value={search} id="search" className="block w-full px-3 py-2 ps-9 bg-neutral-secondary-medium border-2 border-[#2EA1FF] rounded-lg  text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body" placeholder="Search for Products, Brands and More" required />
